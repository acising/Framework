...
public class E5DataDump extends DataDump{
    private File rootDir,basic;
    private HashMap<String,String> DumpConfigMap;
    private HashMap<UUID,HostInfo> HostMap = new HashMap<>();
    private HashMap<Integer,UUID> subjectMap = new HashMap<>();
    private HashMap<Integer,CharSequence> subjectNameMap = new HashMap<>();
    private FileWriter baiscFileWriter;
...
class HostInfo{
    private String name;
    private File hostDumpDir;
    private HashMap<UUID, PrincipalInfo> principalInfoHashMap;
    private FileWriter fileWriterNet;
    private FileWriter fileWriterIpc;
    private FileWriter fileWriterFile;
    private FileWriter fileWriterPrincipal;
    private FileWriter fileWriterAlert;
...
class PrincipalInfo{
    private File principalDumpDir;
    private String hostDir;
    private HashMap<WriteType,FileWriter> writeTypeFileWriterHashMap = new HashMap<>();
    //private HashMap<String,FileWriter> subjectEvent = new HashMap<>();
    private HashMap<String,Integer> subject2Number = new HashMap<>();
    //private HashMap<EventType, Event> reduceData = new HashMap<>();
    private FileWriter fileWriterNode;
    private FileWriter fileWriterAlert;
