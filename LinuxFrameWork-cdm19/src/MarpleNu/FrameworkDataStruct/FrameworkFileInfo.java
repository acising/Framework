...
public class FrameworkFileInfo {
    ...
    private static String[] Top10ProcFileSystemAccesses = {
            "/proc/net/route",
            "/proc/filesystems",
            "/proc/stat",
            "/proc/net/tcp",
    ...
    private static String[] Top10SysFileSystemAccesses = {
    ...
    private static String[] Top10SEtcFileSystemAccesses = {
            "/etc/rc.d/rc.local",
            "/etc/rc.conf",
            "/etc/resolv.cof",
            "/etc/nsswitch.conf",
    ...
    /*by yjk*/
    private static String[] UploadDirectories = {
